...
// мы можем ей передать обычный объект - 
...
// мы можем ей передать обычный объект, даже если в нём нет всех методов, 
// задекларированных в интерфейсе ISpeed, 
// если применим явное преобразование типа
trainer(<ISpeed>car3);
// но trainer, конечно, сработать не сможет - 
// на этапе выполнения кода в браузере окажется что метода stop нет
